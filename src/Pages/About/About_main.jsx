  ...
  return (
    <div className="About_main">
        ...
        <div>
          ...
          <span>{t("About_main.head1")} <div>{t("About_main.head2")}</div></span>
        </div>
      </div>
      <div className="row">
      ...
      <div className="row">
        <div className="col-lg-5 d-flex flex-row">
          <button className='btn1'>{t("About_main.btn1")}<i className="fa-solid fa-download ms-3"></i></button>
        </div>
      </div>
      </div>
          </div>
        ...
        <div className="col-lg-6 ms-lg-5 ms-sm-0 d-flex flex-column header" data-aos="fade-right" style={{fontSize:"50px", fontWeight:"600"}}>
            <span>{t("About_main.p1")}</span>
            <span className="mx-5">{t("About_main.p2")}</span>
            <svg className="rectangle" width="631" height="490" viewBox="0 0 531 690" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g opacity="0.1">
        ...
        <div className="container container4">
          <div className="row">
            <div className="col-lg-3 cards"><h2>14</h2><span>{t("About.col-4")}</span>
            </div>
            <div className="col-lg-3 cards"><h2>4000+</h2><span>{t("About.col-1")}</span>
            </div>
            <div className="col-lg-3 cards"><h2>150+</h2><span>{t("About.col-2")}</span>
            </div>
            <div className="col-lg-3 cards"><h2>16</h2><span>{t("About.col-3")}</span>
            </div>
            </div>
            <div className="row">
            <div className="col-lg-3 cards"><h2>250+</h2><span>{t("About.col-5")}</span>
            </div>
            <div className="col-lg-3 cards"><h2>9+</h2><span>{t("About.col-7")}</span>
            </div>
          </div>
        </div>
        {/* <Contact/> */}
