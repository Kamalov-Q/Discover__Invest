  ...
  return (
    <div className="Contacts_main">
        ...
        <div className="row">
          ...
          <div className="col-lg-4">
            <div className="row">
                ...
                <input type="tel" className="form-control" placeholder="+998" required/>
                <div className="form-text">
                    {t("Navbar.select.op1")}
                </div>
                <select
              ...
              >
                ...
                <textarea className=" form-control" cols={30} rows={10} placeholder="Leave your question.."></textarea>
      ...
      <div className="row">
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d11983.182925001685!2d69.2758336!3d41.335055!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sru!2s!4v1717763375237!5m2!1sru!2s"  style={{border:"0", width:"100%", height:"70vh", marginBottom:"100px"}} allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
      </div>
      <Contact_main/>
